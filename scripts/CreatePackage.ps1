...
if (-not $PortableDirectory) { $PortableDirectory = Join-Path $OutputDirectory 'NativePerfMonitor-1.3.0' }
...
@{ owner='NativePerfMonitor-6D845648-584B-48CE-9904-03E95B0B69E2-v1.3'; version='1.3.0' } |
...
$archive = Join-Path $OutputDirectory 'NativePerfMonitor-1.3.0-win-x64.zip'
