...
$identity = 'NativePerfMonitor-6D845648-584B-48CE-9904-03E95B0B69E2-v1.2'
...
function New-Fixture([string]$Name) {
    ...
    @{ owner=$identity; version='1.2.0' } | ConvertTo-Json | Set-Content -LiteralPath (Join-Path $package 'package-manifest.json')
