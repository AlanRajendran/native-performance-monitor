...
and registers Native Performance Monitor 1.5 in Windows Installed Apps.
...
Settings are in %LOCALAPPDATA%\NativePerfMonitor-1.5.
Installed files are in %LOCALAPPDATA%\Programs\NativePerfMonitor-1.5.
