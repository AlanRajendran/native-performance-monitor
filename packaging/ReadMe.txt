...
and registers Native Performance Monitor 1.6 in Windows Installed Apps.
...
Settings are in %LOCALAPPDATA%\NativePerfMonitor-1.6.
Installed files are in %LOCALAPPDATA%\Programs\NativePerfMonitor-1.6.
